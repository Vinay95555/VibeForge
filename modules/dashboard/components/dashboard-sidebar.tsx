                    ...
                    <SidebarGroupContent>
                        <SidebarMenu>
                            {starredPlaygrounds.length === 0 ? (
                                <div className="text-center text-muted-foreground py-2 text-xs w-full">No starred playgrounds</div>
                            ) : (
                    ...
                    <SidebarGroupContent>
                        <SidebarMenu>
                            {recentPlaygrounds.length === 0 ? (
                                <div className="text-center text-muted-foreground py-2 text-xs w-full">Create your playground</div>
                            ) : (
