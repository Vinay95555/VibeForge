                    ...
                    <TableBody>
                        {projects.map((project) => (
                            <TableRow key={project.id}>
                                ...
                                <TableCell>
                                    <DropdownMenu>
                                        <DropdownMenuTrigger className="inline-flex items-center justify-center h-8 w-8 rounded-md hover:bg-accent text-muted-foreground hover:text-foreground">
                                            <MoreHorizontal className="h-4 w-4" />
                                            <span className="sr-only">Open menu</span>
                                        </DropdownMenuTrigger>
                                        <DropdownMenuContent align="end" className="w-48">
                                            <DropdownMenuItem>
                                                <Link href={`/playground/${project.id}`} className="flex items-center w-full">
                                                    <Eye className="h-4 w-4 mr-2" />
                                                    Open Project
                                                </Link>
                                            </DropdownMenuItem>
                                            <DropdownMenuItem>
                                                <Link href={`/playground/${project.id}`} target="_blank" className="flex items-center w-full">
